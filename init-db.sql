...
-- Index for fast merchant payment lookups
...
-- ─────────────────────────────────────────
-- SEED: Demo merchant for local testing
-- ─────────────────────────────────────────
INSERT INTO merchants (id, name, email, api_key, callback_url, rate_limit)
VALUES (
    uuid_generate_v4(),
    'Demo Merchant',
    'demo@merchant.com',
    'test-api-key-demo-1234567890abcdef',
